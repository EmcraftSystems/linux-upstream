    ...
    struct sn65dsi83 *sn65dsi83)
{
    ...
    bool reverse_lvds = false;
    u32  override_dsi_freq = 0;
    ...
    reverse_lvds = of_property_read_bool(np, "ti,reverse-lvds");
    of_property_read_u32(np, "ti,dsi-freq", &override_dsi_freq);
    sn65dsi83->brg->reverse_lvds = reverse_lvds;
    sn65dsi83->brg->override_dsi_freq = override_dsi_freq;
