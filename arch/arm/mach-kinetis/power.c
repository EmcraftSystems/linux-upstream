...
{
	kinetis_periph_scgc0 = KINETIS_SIM_RD(scgc[0]);
	kinetis_periph_scgc1 = KINETIS_SIM_RD(scgc[1]);
	kinetis_periph_scgc2 = KINETIS_SIM_RD(scgc[2]);
	kinetis_periph_scgc3 = KINETIS_SIM_RD(scgc[3]);
	kinetis_periph_scgc4 = KINETIS_SIM_RD(scgc[4]);
	kinetis_periph_scgc5 = KINETIS_SIM_RD(scgc[5]);
	kinetis_periph_scgc6 = KINETIS_SIM_RD(scgc[6]);
}
...
{
	KINETIS_SIM_WR(scgc[0], kinetis_periph_scgc0);
	KINETIS_SIM_WR(scgc[1], kinetis_periph_scgc1);
	KINETIS_SIM_WR(scgc[2], kinetis_periph_scgc2);
	KINETIS_SIM_WR(scgc[3], kinetis_periph_scgc3);
	KINETIS_SIM_WR(scgc[4], kinetis_periph_scgc4);
	KINETIS_SIM_WR(scgc[5], kinetis_periph_scgc5);
	KINETIS_SIM_WR(scgc[6], kinetis_periph_scgc6);
}
...
int kinetis_periph_enable(kinetis_clock_gate_t gate, int enable)
{
	...
	scgc = KINETIS_SIM_RD(scgc[KINETIS_CG_REG(gate)]);
	...
	if (enable)
		...
		scgc &= ~mask;
	KINETIS_SIM_WR(scgc[KINETIS_CG_REG(gate)], scgc);
...
void kinetis_periph_print_all(void)
{
	...
	for (i = 0; i < 7; ++i) {
		dbg_print("SCGC#%d: %08x\n", i, KINETIS_SIM_RD(scgc[i]));
	}
}
