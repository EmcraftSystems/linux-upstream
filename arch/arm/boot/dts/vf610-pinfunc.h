...
#define VF610_UART_PAD_CTRL	(PAD_CTL_PUS_100K_UP | PAD_CTL_SPEED_MED |	\
				 PAD_CTL_DSE_25ohm)
#define VF610_SDHC_PAD_CTRL	(PAD_CTL_PKE | PAD_CTL_PUE |			\
				 PAD_CTL_PUS_100K_UP | PAD_CTL_SPEED_HIGH |	\
				 PAD_CTL_DSE_20ohm | PAD_CTL_OBE_IBE_ENABLE)

#define VF610_ENET_PAD_CTRL	(PAD_CTL_SRE_FAST | PAD_CTL_SPEED_HIGH |	\
				 PAD_CTL_DSE_75ohm)

#define VF610_I2C_PAD_CTRL      (PAD_CTL_DSE_50ohm | PAD_CTL_PUS_47K_UP |	\
				 PAD_CTL_SPEED_HIGH)
#define VF610_NAND_PAD_CTRL	(PAD_CTL_SPEED_HIGH | PAD_CTL_SRE_FAST |	\
				 PAD_CTL_DSE_50ohm | PAD_CTL_PUS_47K_UP)
#define VF610_DSPI_PAD_CTRL	(PAD_CTL_SPEED_LOW | PAD_CTL_DSE_25ohm)

#define VF610_GPIO_CTRL		(PAD_CTL_SPEED_MED | PAD_CTL_DSE_25ohm |	\
				 PAD_CTL_PUS_100K_UP)
#define VF610_DCU_PAD_CTRL	(VF610_HIGH_DRV | PAD_CTL_OBE_ENABLE)
...
#define VF610_PAD_PTA28__ESDHC1_DAT2		0x048 0x000 ALT5 0x0
